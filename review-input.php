...
$product = $sql->fetch();
echo '<h2>商品レビュー</h2>';
echo '<p><img src="img/products/' . htmlspecialchars($product['product_picture'], ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($product['product_name'], ENT_QUOTES, 'UTF-8') . '" style="max-width:100%;height:auto;"></p>';
